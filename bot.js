...
client.user.setGame(` =help | Venus System ✨ `,"https://www.twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=520714082970632232&permissions=8&scope=bot')
  .setDescription(`**
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("454724311194927114").sendEmbed(embed)
});
...
client.on('guildDelete', guild => {
     ...
     .setURL('https://discordapp.com/api/oauth2/authorize?client_id=520714082970632232&permissions=8&scope=bot')
  .setDescription(`**
  Server Kicked Venus System :cry:
اسم السيرفر: ${guild.name}
صاحب السيرفر: ${guild.owner}**`);
client.channels.get("454724311194927114").sendEmbed(embed)
});
...
if (message.content.startsWith('LG=bcall')){
 if (message.author.id !== '454724311194927114') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
...
client.users.get("454724311194927114","327485669511528449").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
  ...
  client.on('message', message => {
    ...
    var omar;
      if(mentionned){
        ...
        .setFooter('Venus System.',client.user.avatarURL) 
      message.channel.sendEmbed(embed);
    }
});
